...
n = atoi(argv[2]);
tol = atof(argv[3]);
nthreads = atoi(argv[4]); // Getting the no of threads from arguments
...
// parallel region outside while loop
...
printf("The total execution time for Jacobi-OpemMP in mircorsconds is : %ld\n", totalTime);
